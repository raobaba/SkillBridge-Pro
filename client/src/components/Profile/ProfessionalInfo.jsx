...
export default function ProfessionalInfo({ editing, form, handleChange, userData }) {
  return (
    <div className="bg-white/5 border border-white/10 rounded-xl p-6">
      ...
      {editing ? (
        ...
        <>
          ...
          <p><strong>Availability:</strong> {userData?.availability || "N/A"}</p>
          <p><strong>Domain Preferences:</strong> {userData?.domainPreferences || "N/A"}</p>
        </>
      )}
    </div>
  );
