        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              ...
              <div className="text-3xl font-bold text-white mb-2">{formatCurrency(adminStats?.totalRevenue)}</div>
            ...
            <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              ...
              <div className="text-3xl font-bold text-white mb-2">{adminStats?.activeSubscriptions.toLocaleString()}</div>
            ...
            <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              ...
              <div className="text-3xl font-bold text-white mb-2">{adminStats?.pendingPayments}</div>
            ...
            <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              ...
              <div className="text-3xl font-bold text-white mb-2">{adminStats?.disputes}</div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-right">
                      ...
                      <div className={`flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r ${getDisputeStatusColor(dispute.status)} text-white font-semibold shadow-md group-hover:shadow-lg transition-all duration-300`}>
      ...
      <div className="bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-white/10 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-white">Suspended Accounts</h2>
          </div>
                  ...
                  <div className="flex items-center gap-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-300">Reason: {account.reason}</p>
                      </div>
                    </div>
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              ...
              <div className="text-2xl font-bold text-white mb-2">{formatCurrency(12500)}</div>
            ...
            <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-white">New Subscriptions</h3>
              </div>
            ...
            <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-white">Payment Success Rate</h3>
              </div>
