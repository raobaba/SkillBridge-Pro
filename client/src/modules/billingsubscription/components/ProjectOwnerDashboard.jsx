...
const ProjectOwnerDashboard = ({ data }) => {
  const { subscription, billingHistory, paymentMethods, projectListings } = data;
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-white">Project Owner Dashboard</h2>
            </div>
            <div className="flex items-center gap-4">
              <div className="text-right">
                <p className="text-sm text-gray-300">Next Billing</p>
                <p className="text-white font-semibold">{formatDate(subscription.nextBillingDate)}</p>
              </div>
              <div className={`px-4 py-2 rounded-lg text-sm font-semibold bg-gradient-to-r from-emerald-500 to-green-600 text-white`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              ...
              <div className="text-2xl font-bold text-white mb-2 capitalize">{subscription.projectVisibility}</div>
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-white">Project Listings</h2>
            </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-300">
                          Visibility: <span className="capitalize">{project.visibility}</span>
                        </p>
                      </div>
                    </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-6">
                    ...
                    <div className={`px-3 py-1 rounded-lg bg-gradient-to-r from-blue-600 to-blue-800 text-white text-xs font-semibold shadow-md`}>
                      {method.brand}
                    </div>
                  </div>
