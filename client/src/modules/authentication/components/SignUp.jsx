  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label className="block mb-2 text-sm font-medium text-gray-300">Experience (years)</label>
          <input
            type="number"
            name="experience"
        ...
        <div>
          <label className="block mb-2 text-sm font-medium text-gray-300">Preferred Domains</label>
          <input
            type="text"
            name="domains"
