...
// import { Input, Button, StackOverflowIcon } from "../../../components/ui/Card";
// import {
//   getUserProfile,
//   updateUserProfile,
//   deleteUser,
...
//       if (!["resume", "avatar", "avatarPreview"].includes(key)) {
//         formData.append(
//           key,
...
//                 <Mail className='w-4 h-4 mr-2' /> {user?.email || "No email"}
//               </p>
//               <p className='text-gray-400 flex items-center justify-center sm:justify-start'>
...
//                   {/* Add button (optional, if user prefers clicking instead of Enter) */}
//                   <Button
//                     variant='outline'
//                     className='text-sm'
//                     onClick={() => {
...
//             </h2>
//             <p>
//               Email: {user?.notificationPrefs?.email ? "Enabled" : "Disabled"}
//             </p>
//             <p>SMS: {user?.notificationPrefs?.sms ? "Enabled" : "Disabled"}</p>
//           </div>
...
//             </p>
//             <p>
//               <strong>Level:</strong> {user?.level ?? 0}
//             </p>
//             <p>
//               <strong>Portfolio Score:</strong> {user?.portfolioScore ?? 0}
//             </p>
//           </div>
...
export default function ProfilePage() {
  ...
  const handleSave = () => {
    const formData = new FormData();
    Object.entries(form).forEach(([key, value]) => {
      if (key !== "resume" && key !== "avatar" && key !== "avatarPreview") {
        formData.append(
          key,
          typeof value === "object" ? JSON.stringify(value) : value
        );
          ...
          <div className='bg-white/5 border border-white/10 rounded-xl p-6 flex flex-col sm:flex-row items-center sm:items-start sm:space-x-6 space-y-4 sm:space-y-0'>
            <div className='w-24 h-24 rounded-full border-2 border-blue-400 overflow-hidden bg-gray-800 relative'>
              <label className='cursor-pointer w-full h-full flex items-center justify-center'>
                ...
                {form?.avatarPreview ? (
                  // 🔥 Show preview if a new file was selected
                  <img
                    src={form.avatarPreview}
                    alt='Preview'
                    className='w-full h-full object-cover'
