...
export default function ProjectOwnerView() {
  ...
  const recentNotifications = [
    ...
    },
    {
      ...
      type: "message",
      title: "New Message",
      message: "Alice Johnson sent you a message regarding the Next Gen Web Platform.",
      time: "1 day ago",
      unread: false,
    },
    {
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex flex-1 max-w-md mx-8">
              <div className="relative w-full">
                ...
                <input
                  type="text"
                  placeholder="Search projects, team members, or skills..."
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-4 hover:border-white/20 transition-all">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-400">{ownerStats.activeProjects}</p>
              </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-4 hover:border-white/20 transition-all">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-400">{ownerStats.completedProjects}</p>
              </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-4 hover:border-white/20 transition-all">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-yellow-400">{ownerStats.teamMembers}</p>
              </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-4 hover:border-white/20 transition-all">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-400">{ownerStats.totalBudget}</p>
              </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-4 hover:border-white/20 transition-all">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-400">{ownerStats.rating}</p>
              </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-4 hover:border-white/20 transition-all">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-pink-400">{ownerStats.openPositions}</p>
              </div>
