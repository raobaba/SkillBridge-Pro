    ...
    <div className='bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-white/10 relative overflow-hidden'>
      ...
      <div className='relative z-10 mb-8'>
        <div className='flex items-center gap-3 mb-2'>
          ...
          <h2 className='text-3xl font-bold text-white'>Skill Gap Analyzer</h2>
        </div>
        <p className='text-gray-300 text-sm'>
          Identify skills you need to develop for your career goals
        </p>
      </div>
        ...
        {gaps.length > 0 ? (
              ...
              <div className='relative z-10'>
                ...
                <div className='flex items-center gap-3 mb-4'>
                  ...
                  <div className='flex-1'>
                    ...
                    <div
                      className={`px-2 py-1 rounded-full text-xs font-semibold bg-gradient-to-r ${getCategoryColor(gap.category)} text-white inline-block`}
                    >
                      {gap.category}
                    </div>
                  </div>
                  <div
                    className={`px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r ${getGapLevelColor(gap.gapLevel)} text-white`}
                  >
                    {gap.gapLevel} Gap
                  </div>
                </div>
                ...
                <div className='grid grid-cols-2 gap-4'>
                  <div className='text-center'>
                    ...
                    <div
                      className={`px-3 py-2 rounded-xl text-sm font-semibold bg-gradient-to-r ${getLevelColor(gap.required)} text-white shadow-md`}
                    >
                      {gap.required}
                    </div>
                  </div>
                  <div className='text-center'>
                    ...
                    <div
                      className={`px-3 py-2 rounded-xl text-sm font-semibold bg-gradient-to-r ${getLevelColor(gap.current)} text-white shadow-md`}
                    >
                      {gap.current}
                    </div>
                  </div>
          ...
          <div className='text-center py-12'>
            <p className='text-gray-400'>
              No skill gaps identified yet. Check back soon!
            </p>
          </div>
        )}
      </div>
                ...
                >
                  <div className='grid grid-cols-12 gap-4 items-center'>
                    ...
                    <div className='col-span-3 flex items-center gap-3'>
                      <div className='w-8 h-8 bg-gradient-to-br from-blue-500/20 via-purple-500/20 to-pink-500/20 rounded-lg flex items-center justify-center text-lg  transition-transform duration-300'>
                        {gap.icon}
                      </div>
                      <div>
                    ...
                    <div className='col-span-2'>
                      <div
                        className={`px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r ${getCategoryColor(gap.category)} text-white inline-block`}
                      >
                        {gap.category}
                      </div>
                    </div>
                    ...
                    <div className='col-span-2'>
                      <div
                        className={`px-3 py-1 rounded-lg text-sm font-semibold bg-gradient-to-r ${getLevelColor(gap.required)} text-white text-center`}
                      >
                        {gap.required}
                      </div>
                    </div>
                    ...
                    <div className='col-span-2'>
                      <div
                        className={`px-3 py-1 rounded-lg text-sm font-semibold bg-gradient-to-r ${getLevelColor(gap.current)} text-white text-center`}
                      >
                        {gap.current}
                      </div>
                    </div>
                    ...
                    <div className='col-span-1'>
                      <div
                        className={`px-2 py-1 rounded-full text-xs font-semibold bg-gradient-to-r ${getGapLevelColor(gap.gapLevel)} text-white text-center`}
                      >
                        {gap.gapLevel}
                      </div>
                    </div>
      ...
      <div className='relative z-10 mt-8'>
        <div className='flex items-center justify-between'>
          ...
          <Button className='px-6 py-2 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white text-sm font-semibold rounded-xl hover:from-blue-600 hover:via-purple-600 hover:to-pink-600 transition-all duration-300'>
            View Learning Path
          </Button>
        </div>
      </div>
